...
echo 'export FORTHEPET_DB_DEV=postgresql://ftp_user:password@192.168.77.23/forthepet_dev?pool=5' >> /etc/profile
echo 'export FORTHEPET_DB_TEST=postgresql://ftp_user:password@192.168.77.23/forthepet_test?pool=5' >> /etc/profile
echo 'export FORTHEPET_DB_PRODUCTION=postgresql://ftp_user:password@192.168.77.23/forthepet?pool=5' >> /etc/profile
